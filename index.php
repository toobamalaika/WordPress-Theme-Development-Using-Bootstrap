            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <a href="#" class="thm-btn static-banner-one__btn">Request a Consultation</a>
                    </div><!-- /.col-lg-6 -->
                </div><!-- /.row -->
            </div><!-- /.container -->
        ...
        <section class="service-two">
            <div class="container">
                <div class="sec-title text-center">
                    <span class="tag-line ">Inston tasks</span>
                    <h2 class="title-line ">Supercharge your life with a <br> Inston virtual assistant.</h2>
        ...
        <section class="thm-black-bg service-one">
            <div class="container">
                <div class="sec-title text-center">
                    ...
                    <h2 class="title-line light">What can inston help <br> me with?.</h2>
                    <span class="line-block "></span>
                </div><!-- /.sec-title -->
                <div class="row">
                    <div class="col-lg-4">
        ...
        <section class="map-style-one">
            ...
            <div class="container text-center">
                ...
                <div class="button-block text-center">
                    <a class="thm-btn" href="#">Request a Consultation</a>
